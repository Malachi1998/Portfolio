  ...
  return (
    <div className="nav-bar">
      ...
      <ul> {/*establecemos lista de elementos de la sidebar*/}
        ...
        <li>
          <a
            href="https://github.com/Malachi1998" //vinculamos url de GitHub personal
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li>
          <a
            href="#" //falta vincular un canal profesional de YOUTUBE
            rel="noreferrer"
            target="_blank"
          >
            <FontAwesomeIcon //vinculamos logo de YOUTUBE
              icon={faYoutube}
              color="#4d4d4e"
              className="anchor-icon"
            />
